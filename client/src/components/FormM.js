...
const FormM = () => {
  ...
  const handleSubmit = (e) => {
    ...
    Axios.post("/api/uploadInfo", variables).then((response) => {
  ...
  return (
    <>
      <Box
        component="div"
        style={{ background: "#233", height: "220vh" }}
      ></Box>
      ...
      <Grid container justify="center">
        <Box component="form" className={classes.form}>
          ...
          <br />
          <FormLabel className={classes.ledgend} component="legend">
          ...
          <FormLabel className={classes.ledgend} component="legend">
            2. Explain your service /blog / product.{" "}
          </FormLabel>
          <InputField
            fullWidth={true}
            label="Type Here"
          ...
          <FormLabel className={classes.ledgend} component="legend">
            3.Any competitor or reference website?{" "}
          </FormLabel>
          <InputField
            fullWidth={true}
            label="Website Link"
          ...
          <FormLabel className={classes.ledgend} component="legend">
            4. Which platform you want to use?
          </FormLabel>
          <FormGroup>
            <FormControlLabel
              control={<Checkbox />}
          ...
          <br />
          <FormLabel className={classes.ledgend} component="legend">
            5. Do you have domain name & hosting space?
          </FormLabel>
          <FormGroup>
            <FormControlLabel
              control={<Checkbox />}
          ...
          >
            ...
            />
            <FormControlLabel
              value="Blog based website with multiple category"
              control={<Radio />}
              label="Blog based website with multiple category"
            />
          </RadioGroup>
